...
SECRET_KEY = '0g%+@s-f)xe(8x-y6dj!+=ycjco2xav44x$14oa#zr8j-bs2m6'
...
MIDDLEWARE = [
    ...
    # 'post.middlewares.FirstMiddleware',
    # 'post.middlewares.SecondMiddleware',
]
...
AUTHENTICATION_BACKENDS = [
    ...
    'post.backends.MasterKeyBackend',
]
